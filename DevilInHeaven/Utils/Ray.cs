...
namespace Black_Magic
{
    public class Ray
    {
        ...
        public Vector2? cast(List<Rigidbody> rigidbodies, Rigidbody self) //TODO: CHANGE TO GET SQUARE DISTANCE
        {
            ...
            for (int i = 0; i < maxSteps; i++)
            {
                ...
                foreach (Rigidbody rigidbody in rigidbodies)
                {
                    ...
                    if (rigidbody == self ||
                        ...
                        self.ignoreTypes.Contains(rigidbody.parent.GetType()) ||
                        !rigidbody.isActive) continue;
        ...
        public Vector2? cast<T>(List<T> entities, Entity self) where T : Entity
        {
            Vector2 rayTip = new Vector2(pos.X, pos.Y);
